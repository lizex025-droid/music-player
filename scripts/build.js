...
if (!html.includes('PWA_NATIVE_INSTALL_V4')) {
  html = html.replace('</head>', `
<!-- PWA_NATIVE_INSTALL_V4: Chromium controls the native address-bar install UI -->
...
console.log('Built drag reorder + multi-select + favicon-backed native PWA icon support');
